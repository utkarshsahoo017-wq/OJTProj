            ...
            <div className="relative z-10 w-full h-auto flex justify-center mt-40">
                <div className="text-white bg-[#1e2844]/30 w-2xl h-auto p-3 rounded-xl border-2 border-gray-500 font-semibold text-3xl flex flex-col gap-3 backdrop-blur-lg">
                    ...
                    <div className="input flex flex-col gap-4 mt-10 items-center">
                        ...
                        <input type="email" placeholder='Enter email' className='text-white text-lg border border-gray-500 rounded-full px-4 py-1 placeholder:font-light font-light w-3/4' />
                    ...
                    <div className="buttons flex flex-col items-center text-xl gap-2">
                        <NavLink to="/dashboard" className='bg-blue-500 rounded-full w-1/3 border-2 border-blue-300 py-1 hover:cursor-pointer hover:shadow-[0px_0px_5px_white] transition text-center'><button>Signup</button></NavLink>
